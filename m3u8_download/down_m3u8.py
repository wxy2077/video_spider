...
class DownM3u8(object):
    def __init__(self, m3u8_url, file_name='./upload.ts'):
    ...
    def ts_to_mp4():
        infile = './upload.ts'
        outfile = './upload.mp4'
        # 如果没有安装 ffmpeg 可以直接查看合并好的 upload.ts 也是可以播放的
        subprocess.run(['ffmpeg', '-i', infile, outfile])


if __name__ == '__main__':
    d = DownM3u8("http://cctvalih5ca.v.myalicdn.com/live/cctv1_2/index.m3u8")
    d.download_all_ts()
    d.ts_to_mp4()
